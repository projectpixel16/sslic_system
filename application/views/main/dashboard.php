...
<body>
  ...
  <section id="hero" class="d-flex justify-cntent-center align-items-center">
      <div id="" class="container carousel carousel-fade" data-ride="">
        ...
        <div class="carousel-item active">
          <div class="carousel-container">
            ...
            <a href="<?php echo base_url() ?>main/login" class="btn-get-started animate__animated animate__fadeInUp !bg-orange-500 hover:!bg-orange-600">Apply Loan Now</a>
          </div>
        </div>
      </div>
  </section><!-- End Hero -->
